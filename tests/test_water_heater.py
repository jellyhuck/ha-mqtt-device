...
async def test_default_discovery_and_state_topics() -> None:
    ...
    assert heater.discovery_config() == {
        "uniq_id": "boiler",
        "p": "water_heater",
        "curr_temp_t": "homeassistant/device/dev-1/boiler/state/current_temperature",
        "temp_stat_t": "homeassistant/device/dev-1/boiler/state/temperature",
        "temp_cmd_t": "homeassistant/device/dev-1/boiler/command/temperature",
        "mode_stat_t": "homeassistant/device/dev-1/boiler/state/mode",
        "mode_cmd_t": "homeassistant/device/dev-1/boiler/command/mode",
    }
...
async def test_optional_discovery_and_custom_payloads() -> None:
    ...
    assert heater.discovery_config() == {
        ...
        "mode_stat_t": "homeassistant/device/dev-1/boiler/state/mode",
        "mode_cmd_t": "homeassistant/device/dev-1/boiler/command/mode",
        "power_command_topic": "homeassistant/device/dev-1/boiler/command/power",
        "modes": ["off", "eco"],
        "min_temp": 115,
        "max_temp": 135,
        "init": 120,
