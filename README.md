...
- **Entity management**: add and maintain multiple entities (sensors, switches, binary sensors, dates, datetimes, humidifiers, cameras, device trackers, etc.) that belong to a device.
